...
import { Flex, Box, Heading, Select, Text, Tooltip } from "@chakra-ui/react";
...
return (
  ...
  <Text fontSize='3xl' as="b">Tendencias</Text>
    <Select
      label="Categorías"
      width="56"
      paddingLeft="3"
    ...
    >
      <option value="all" onClick={() => handleTrendingCategory("all")}>
        Todos
      </option>
      {categories?.map((cat) => (
        <option
